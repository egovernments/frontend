const configs = {
    ...
    'CHART_COLOR_CODE':["#35a2eb", "#f19c56", "#4c76c7", "#ff6384", '#FFC107', '#009688', '#9C27B0', '#4CAF50',"#99d4fa", "#179cf4", "#1d9cf4", "#1sacq4", "#1gvcf4","ff8585","54e346","af2d2d","892cdc","aa3a3a","fcf876","f9813a","bedbbb","fa7f72","394867","e6739f","f6830f","0e918c","2d6187","a8dda8","ffe05d","b8de6f"],
    'MODULE_LEVEL':[
                    {'dashboard':null},
