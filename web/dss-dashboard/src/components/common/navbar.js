...
return(<div style={{boxShadow: '0 1px 4px 0 rgba(0, 0, 0, 0.1)',height: '65px',backgroundColor: 'white'}}>
            <nav className="navbar navbar-light sticky-top flex-md-nowrap">
                 ...
                 <ul className="navbar-nav px-3 list-inline">
                     ...
                     <li className="nav-item dropdown">
                         ...
                         <a className="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Vishnu</a>
                    </li>
                     <li>
