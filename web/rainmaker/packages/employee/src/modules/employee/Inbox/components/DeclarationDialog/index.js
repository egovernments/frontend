...
const DeclarationDialog = ({ popupClose, popupOpen }) => {
  ...
  return (
    <Dialog
      ...
      children={[
        <Label label={`It is confirmed that all services available on the e-Chhawani Portal are being processed on the Portal by my Cantonment Board and no manual processing is being done in such matters.`} 
