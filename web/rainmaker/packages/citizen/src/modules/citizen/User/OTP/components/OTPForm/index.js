...
const OTP = ({ handleFieldChange, form, phoneNumber, resendOTP ,logoUrl,history,timerSwitch,completed}) => {
        ...
        <div>
          ...
          />
            ...
            {timerSwitch? (
              ...
              <CountdownTimer timeLeft={60000} completeCallback={completed} tickCallback={tick} />
