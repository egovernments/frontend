...
class TableData extends Component {
  ...
  getAssignedData(responseData)
  {
    ...
    const assignedData = orderBy(
      filter(responseData.ProcessInstances, (item) => {
        ...
        let eligibleRolesToTakeAction = jp.query(businessServiceData, "$[?(@.businessService== 'LAMS_NewLR')].states[?(@.state=='"+
  ...
  componentDidMount = async () => {
    ...
    try {
      ...
      this.setBusinessServiceDataToLocalStorage([{ key: "tenantId", value: getTenantId() },{ key: "businessServices", value: "LAMS_NewLR" }]);
