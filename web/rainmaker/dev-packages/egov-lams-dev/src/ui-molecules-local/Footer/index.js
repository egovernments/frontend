...
class Footer extends React.Component {
  ...
  componentDidMount = () => {
    ...
    console.log(" Footer component loaded. Contract Data is : ", contractData);
  };
    ...
    const downloadMenu =
      ...
      contractData.map(item => {
        ...
        return {
          ...
          link: () => {
            (moduleName === "NewLAMS_LR" || moduleName === "EDITRENEWAL" ) && buttonLabel==="APPLY" ? onDialogButtonClick(buttonLabel, isDocRequired) : 
