...
class MyConnections extends React.Component {
  ...
  getConnectionDetails = data => {
    store.dispatch(
      setRoute(
        `/nod/connection-details?connectionNumber=${data.connectionNo}&tenantId=${data.property.tenantId}&service=${data.service.toUpperCase()}&connectionType=${data.connectionType}`
      )
    );
  }
  ...
  getViewBillDetails = data => {
    store.dispatch(
      setRoute(
        `/nod/viewBill?connectionNumber=${data.connectionNo}&tenantId=${data.property.tenantId}&service=${data.service.toUpperCase()}&connectionType=${data.connectionType}`
      )
    );
  }
