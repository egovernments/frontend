...
export const generateWSAcknowledgement = (preparedFinalObject, fileName = "print", service, connType) => {
    ...
    let pdfData = {
        ...
        cards: [
            ...
            { header: 'PDF_STATIC_LABEL_WS_CONSOLIDATED_ACKNOWELDGMENT_ROAD_CHARGES_HEADER', items: roadDetail, type: roadDetailInfo.length > 1 ? 'multiItem' : 'singleItem',  hide: roadDetailInfo.length === 0},
