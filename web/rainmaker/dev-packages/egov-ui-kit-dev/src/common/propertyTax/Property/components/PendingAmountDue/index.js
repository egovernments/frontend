          ...
          <div style={{ margin: 16 }}>
            ...
            <div>
              ...
              <div style={payNowButton} >
                <div style={labelStyle} ><Label label="PT_COMMON_RS"/><span>{amount}</span></div>
              ...
              <Label fontSize="18px" label="PT_WATER_BILL_DUE" />
              {
                waterDetails && waterDetails.length > 0 ? (waterDetails.map(items => {
                  if(items.module === "WS") {
                    return (
                      <div style={payNowButton} >
                        <div style={labelStyle}><Label label="PT_COMMON_RS" />{items.waterDue}</div>
                  ...
                  <div style={payNowButton} >
                    <div style={labelStyle}><Label label="PT_COMMON_RS" />{0}</div>
              ...
              <Label fontSize="18px" label="PT_SEWERAGE_BILL_DUE" />
              {
                sewerDetails && sewerDetails.length > 0 ? (sewerDetails.map(items => {
                  if(items.module === "SW") {
                    return (
                      <div style={payNowButton} >
                        <div style={labelStyle}><Label label="PT_COMMON_RS" />{items.sewerDue}</div>
