                              ...
                              <TextField
                                ...
                                onChange={(e) => {  
                                 ...
                                 var isValidinput = !!input.match(NumbersOnly)
                                  ...
                                  taxData.code === "PT_LIBRARY_CESS" || taxData.code === "PT_CONSERVE_TAX" || taxData.code === "PT_SPECIAL_CONSERVANCY_TAX" || 
                                  taxData.code === "PT_CONCERVANCY_CHARGES" || taxData.code === "PT_RECORD_MAINTENANCE_FEES" || taxData.code === "PT_GARBAGE_COLLECTION_FEES"
                                  || taxData.code === "PT_SWATCH_BHARAT_CHARGES")
                                  {
                                      if (Math.sign(e.target.value)===-1) 
                                      {  
                                        this.props.toggleSnackbarAndSetText(
