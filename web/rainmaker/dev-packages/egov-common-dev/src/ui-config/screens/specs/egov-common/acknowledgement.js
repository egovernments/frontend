            ...
            downloadMenu: {
                ...
                props: {
                    data: {
                        ...
                        props: { variant: "outlined", style: { height: "60px", width:"210px",color: "#FE7A51",marginRight:"5px" }, className: "tl-download-button"},
                        menu: downloadMenu
                    },
            ...
            printMenu: {
                ...
                props: {
                    data: {
                        ...
                        leftIcon: "print",
                        rightIcon: "arrow_drop_down",
                        props: { variant: "outlined", style: { height: "60px",width:"180px" ,color: "#FE7A51" }, className: "tl-print-button" },
                        menu: printMenu
                    }
                },
