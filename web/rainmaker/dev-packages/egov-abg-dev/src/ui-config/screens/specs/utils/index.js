...
export const getMergeAndDownloadList = (state, dispatch) => {
        ...
        dispatch(
          handleField(
            ...
            [
              ...
              {
                label: { labelName: "WATER & SEWERAGE CONNECTION", labelKey: "ABG_GROUP_BILLS_WATER_AND_SEWERAGE_CONNECTION_BUTTON" },
