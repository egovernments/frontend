  ...
  Noc.forEach(nocDoc => {
    ...
    applicationDocuments.forEach(doc =>{
      if(doc.applicationType === nocDoc.applicationType && doc.nocType === nocDoc.nocType) {
        ...
        let url = `${window.location.origin}/egov-common-noc/search-preview?applicationNumber=${nocDoc.applicationNo}&tenantId=${nocDoc.tenantId}&isFromBPA=true`;
        if (process.env.NODE_ENV === "production") {
          if (checkingApp) {
            url = `${window.location.origin}/${checkingApp}/egov-common-noc/search-preview?applicationNumber=${nocDoc.applicationNo}&tenantId=${nocDoc.tenantId}&isFromBPA=true`;
          }
        }
