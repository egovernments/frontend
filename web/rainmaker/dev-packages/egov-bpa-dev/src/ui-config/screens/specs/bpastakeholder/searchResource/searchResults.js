...
const onRowClick = rowData => {
  switch (rowData[5]) {
    case "INITIATED":
      routeTo(`/bpastakeholder/apply?applicationNumber=${rowData[0]}&tenantId=${rowData[5]}`);
      break;
    default:
      routeTo(`/bpastakeholder/search-preview?applicationNumber=${rowData[0]}&tenantId=${rowData[5]}`);
      break;
  }
};
