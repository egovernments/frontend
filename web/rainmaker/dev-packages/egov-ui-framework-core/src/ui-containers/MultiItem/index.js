...
class MultiItem extends React.Component {
  ...
  componentWillReceiveProps(nextProps) {
    if (!isEqual(nextProps, this.props)) {
      ...
      this.initMultiItem(nextProps);
    }else if(get(nextProps,`preparedFinalObject.${nextProps.sourceJsonPath}`,[]) && get(nextProps,`preparedFinalObject.${nextProps.sourceJsonPath}`,[]).length!==get(this.props,`items`,[]).length) {
      this.initMultiItem(nextProps);
    }
  }
