...
const options = [
  ...
  { value: "Transgender", label: <Label label="PT_COMMON_GENDER_TRANSGENDER" /> },
];
      ...
      textChildren={
        <div className="pt-owner-info">
          ...
          <div className={`${formKey} col-sm-12`}>
            ...
            <div className="col-sm-6">
              <Label label={"PT_COMMON_GENDER_LABEL"} required fontSize={12} labelStyle={styles.labelStyle} bold={true} />
              <RadioButton
                id="gender-selection"
