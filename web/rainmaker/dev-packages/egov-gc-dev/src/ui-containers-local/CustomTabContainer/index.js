...
class MultiItem extends React.Component {
  ...
  //   dispatch(handleField("search", "components.div.children.searchConnection", "visible", false));
    } else {
   //   resetFieldsForConnection({}, dispatch);
 //     dispatch(handleField("search", "components.div.children.createConnection", "visible", false));
    }
  };
  ...
  onTabChange = (tabIndex, dispatch, state) => {
    switch (tabIndex) {
      case 0:
        ...
        break;
      case 1:
        this.setInstrumentType("CREATE_CONNECTION", dispatch);
        break;
      default:
        this.setInstrumentType("SEARCH_CONNECTION", dispatch);
        break;
