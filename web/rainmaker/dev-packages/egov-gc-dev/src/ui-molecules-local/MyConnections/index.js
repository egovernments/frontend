...
class MyConnections extends React.Component {
  ...
  getConnectionDetails = data => {
    store.dispatch(
      setRoute(
        `/gc/connection-details?connectionNumber=${data.connectionNo}&tenantId=${data.property.tenantId}&service=${data.service.toUpperCase()}&connectionType=${data.connectionType}`
      )
    );
  }
  ...
  getViewBillDetails = data => {
    store.dispatch(
      setRoute(
        `/gc/viewBill?connectionNumber=${data.connectionNo}&tenantId=${data.property.tenantId}&service=${data.service.toUpperCase()}&connectionType=${data.connectionType}`
      )
    );
  }
