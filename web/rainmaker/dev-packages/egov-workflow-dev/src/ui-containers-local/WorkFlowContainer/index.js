  ...
  prepareWorkflowContract = (data, moduleName) => {
    ...
    actions = actions.map(item => {
      return {
        ...
        showEmployeeList: !checkIfTerminatedState(item.nextState, businessService) && item.action !== "SENDBACKTOCITIZEN" && item.action !=="SEND_BACK_TO_CITIZEN" && item.action !=="RESUBMIT_APPLICATION",
