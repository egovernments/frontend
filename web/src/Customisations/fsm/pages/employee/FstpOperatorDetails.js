...
import { Header, MultiUploadWrapper, TextArea } from "@egovernments/digit-ui-react-components";
import {
  Card,
  CardLabel,
  CardLabelError,
...
const FstpOperatorDetails = () => {
  ...
  const workflowDetails = Digit.Hooks.useWorkflowDetails({
    tenantId: tenantId,
    id: window.location.pathname.includes("fstp-operator-details") ? applicationNos : "",
          ...
          <form>
            ...
            <div className={!isMobile && "row"} style={isMobile ? {} : { diplay: "flex", justifyContent: "space-between", alignItems: "center" }}>
              ...
              <TextArea className="form-field"
                onChange={(e) => {e.target.value.length > 1024 && setComments(e.target.value)}}
