...
const getSlumName = (application, t) => {
  ...
  return application?.slum?.i18nKey
    ? t(`${application?.slum?.i18nKey}`)
    : "N/A";
};
...
const getApplicationVehicleType = (application, t) => {
  if (application?.vehicleMake && application?.vehicleCapacity) {
    return getVehicleType(
      {
        i18nKey: application?.vehicleMake,
    ...
    details: [
      {
        ...
        values: [
          ...
          },
          {
            ...
            value: Digit.DateUtils.ConvertTimestampToDate(
          ...
          },
          {
            ...
            value:
              t(
                `ES_APPLICATION_DETAILS_APPLICATION_CHANNEL_${application?.source}`
              ) || "N/A",
          },
        ],
      },
        ...
        values: [
          {
            ...
            value: application?.citizen?.name || "N/A",
          },
          {
            title: t("CS_APPLICATION_DETAILS_APPLICANT_MOBILE"),
            value: application?.citizen?.mobileNumber || "N/A",
          },
        ],
      },
      {
        ...
        values: [
          {
            ...
            value:
              t(getPropertyTypeLocale(application?.propertyUsage)) || "N/A",
          },
          {
            title: t("CS_APPLICATION_DETAILS_PROPERTY_SUB_TYPE"),
            value:
              t(getPropertySubtypeLocale(application?.propertyUsage)) || "N/A",
          },
        ],
      },
      {
        ...
        values: [
          {
            ...
            value: application?.address?.pincode || "N/A",
          },
          {
            title: t("CS_APPLICATION_DETAILS_CITY"),
            value: application?.address?.city || "N/A",
          },
          {
          ...
          },
          {
            ...
            value: application?.address?.street || "N/A",
          },
          {
            title: t("CS_APPLICATION_DETAILS_DOOR_NO"),
            value: application?.address?.doorNo || "N/A",
          },
          {
            title: t("CS_APPLICATION_DETAILS_LANDMARK"),
            value: application?.address?.landmark || "N/A",
          },
        ],
      },
      {
        ...
        values: [
          {
            ...
            value: application?.sanitationtype
              ? t("PITTYPE_MASTERS_" + application?.sanitationtype)
              : "N/A",
          },
          {
            ...
            value:
              ...
              application?.pitDetail?.height !== null
                ? application?.pitDetail?.length
                  ? `${application?.pitDetail?.length}m * ${
                      application?.pitDetail?.width
                    }m * ${
                      application?.pitDetail?.height
                    }m                                  (${t(
                      "CS_COMMON_LENGTH"
                    )} x ${t("CS_COMMON_BREADTH")} x ${t("CS_COMMON_DEPTH")})`
                  : `${application?.pitDetail?.diameter}m * ${
                      application?.pitDetail?.height
                    }m                                  (${t(
                      "CS_COMMON_DIAMETER"
                    )} x ${t("CS_COMMON_DEPTH")})`
          ...
          },
          {
            ...
            value: application?.noOfTrips || "N/A",
          },
          {
